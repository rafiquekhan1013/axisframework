...
export default function Survey() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-32 sm:px-6">
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-cyan-700">Survey</h2>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border border-stone-300 rounded-xl bg-white text-stone-900 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500"
              required
            />
          </div>
          ...
          <h3 className="text-lg font-semibold text-cyan-700">Platform Membership</h3>
          ...
          <div ref={ref} style={{ display: isNext ? "none" : "block" }}>
            <hr className="border-stone-200 my-8" />
            <h3 className="text-lg font-semibold text-cyan-700 mb-6">Rating Questions</h3>
            ...
            <hr className="border-stone-200 my-8" />
            <h3 className="text-lg font-semibold text-cyan-700 mb-6">Final Questions</h3>
            ...
            <div className="mt-8 p-4 bg-stone-50 rounded-xl">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-stone-700">
                  I accept the {siteDisplayName} <NavLink to="/terms" target="_blank" className="text-cyan-600 hover:underline">terms and conditions</NavLink>
                </span>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full mt-6 py-4 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all disabled:opacity-70"
            >
          ...
          {isNext && (
            <button
              type="button"
              onClick={handleNext}
              className="w-full py-4 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white font-semibold rounded-xl hover:shadow-lg transition-all"
            >
              Next
            </button>
          )}
      ...
      {openUpdate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-cyan-400 text-charcoal rounded-xl shadow-xl max-w-md w-full mx-4 p-6">
